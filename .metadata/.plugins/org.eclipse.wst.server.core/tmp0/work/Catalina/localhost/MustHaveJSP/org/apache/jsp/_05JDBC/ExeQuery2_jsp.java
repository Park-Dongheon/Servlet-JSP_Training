 ...
 * Generated at: 2024-06-14 08:19:28 UTC
...
String id = request.getParameter("id");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<h2>사용자 'musthave' 가 작성한 board 목록 출력2</h2>\r\n");
      out.write("	");
	...
	try (JDBConnect jdbc = new JDBConnect();
		...
		while (rs.next()) {
			...
			out.println("<td>" + content2 + "</td>");
			out.println("<td>" + id2 + "</td>");
			out.println("<td>" + postdate2 + "</td>");
			out.println("<td>" + visitcount2 + "</td>");
			out.println("</tr>");
