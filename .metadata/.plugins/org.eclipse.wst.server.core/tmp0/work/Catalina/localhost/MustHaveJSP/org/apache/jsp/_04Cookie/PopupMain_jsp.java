 ...
 * Generated at: 2024-06-13 06:34:08 UTC
...
if (cookies != null) {
	for (Cookie c : cookies) {
      ...
      out.write("		if(chkVal==1) {											// jQuery의 ajax() 함수로 비동기 요청\r\n");
      out.write("			$.ajax({											// 비동기로 요청을 보냅니다.\r\n");
      out.write("				url : './PopupCookie.jsp',						// PopupCookie.jsp파일에\r\n");
      out.write("				type : 'get',									// HTTP GET 방식으로\r\n");
      out.write("				data : {inactiveToday : chkVal},				// inactiveToday=<chkVal 변수의 값> 데이터를\r\n");
      out.write("				dataType : \"text\",								// 응답 데이터의 타입은 일반 텍스트이며\r\n");
      out.write("				success : function(resData) {					// 요청 성공 시 호출되는 함수\r\n");
      out.write("					if (resData != '')							// 응답 데이터가 있다면\r\n");
      out.write("						location.reload();						// 페이지를 새로고칩니다.\r\n");
      out.write("				}\r\n");
      out.write("			});\r\n");
      out.write("		}\r\n");
      out.write("	});\r\n");
