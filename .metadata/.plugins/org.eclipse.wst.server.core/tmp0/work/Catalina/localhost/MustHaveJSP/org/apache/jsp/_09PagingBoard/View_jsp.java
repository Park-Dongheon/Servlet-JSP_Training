 ...
 * Generated at: 2024-06-24 00:17:05 UTC
...
dao.close();									// DB 연결 해제
      ...
      out.write("		var form = document.forms['writeFrm'];	// 이름(name)이 \"writeFrm\"인 폼 선택\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function goToListPage() {\r\n");
      out.write("    // 현재 페이지의 URI 정보 가져오기\r\n");
      out.write("    var currentUrl = window.location.href;\r\n");
      out.write("    \r\n");
      out.write("    // List.jsp로 돌아가기 위해 pageNum 파라미터가 포함된 URI로 변경\r\n");
      out.write("    var listUrl = 'List.jsp';\r\n");
      out.write("    \r\n");
      out.write("    // 현재 URI에서 pageNum 파라미터 가져오기\r\n");
      out.write("    var pageNumParam = getParameterByName('pageNum', currentUrl);\r\n");
      out.write("    \r\n");
      out.write("    // 검색 조건 가져오기\r\n");
      out.write("    var searchFieldParam = getParameterByName('searchField', currentUrl);\r\n");
      out.write("    var searchWordParam = getParameterByName('searchWord', currentUrl);\r\n");
      out.write("    \r\n");
      out.write("    // pageNum 파라미터가 있는 경우에만 추가\r\n");
      out.write("    if (pageNumParam) {\r\n");
      out.write("        listUrl += '?pageNum=' + pageNumParam;\r\n");
      out.write("        \r\n");
      out.write("        // 검색 조건이 있으면 추가\r\n");
      out.write("        if (searchFieldParam && searchWordParam) {\r\n");
      out.write("            listUrl += '&searchField=' + searchFieldParam + '&searchWord=' + searchWordParam;\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    // List.jsp로 이동\r\n");
      out.write("    window.location.href = listUrl;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("// URL에서 파라미터 이름에 해당하는 값을 가져오는 함수\r\n");
      out.write("function getParameterByName(name, url) {\r\n");
      out.write("    if (!url) url = window.location.href;\r\n");
      ...
      out.write("\r\n");
      out.write("				<button type=\"button\"\r\n");
      out.write("						onclick=\"goToListPage()\">\r\n");
      out.write("					목록보기\r\n");
      out.write("				</button>\r\n");
      out.write("			</td>\r\n");
      out.write("		</tr>\r\n");
