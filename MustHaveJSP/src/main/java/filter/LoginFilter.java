...
public class LoginFilter implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		MySQL_Driver = application.getInitParameter("MySQL Driver");
		MySQL_URL = application.getInitParameter("MySQL URL");
		MySQL_Id = application.getInitParameter("MySQL Id");
		MySQL_Pwd = application.getInitParameter("MySQL Pwd");
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (method.equals("POST" )) {	// 로그인 처리
			...
			MemberDAO dao = new MemberDAO(MySQL_Driver, MySQL_URL, MySQL_Id, MySQL_Pwd);
